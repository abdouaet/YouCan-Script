...
if (quantities.length > 1) {
	...
	const button = document.querySelectorAll("button.single-submit");
	const stickyButton = button[1];

	const anchor = document.createElement("a");
	anchor.href = "#express-checkout-form";
	anchor.className = "sticky-anchor single-submit";
	anchor.innerText = stickyButton.innerText;

	stickyButton.replaceWith(anchor);
}